...
public class XmppManager {
	...
	public void login(String name,String password){
		Log.d(LOGTAG, "connect()...");
		submitLoginTaskByUser(name, password);
	}
	...
	private void submitLoginTaskByUser(String name,String password) {
		Log.d(LOGTAG, "submitLoginTask()...");
		submitConnectTask();
		addTask(new LoginTask(name,password));
	}
	...
	private class LoginTask implements Runnable {
		...
		private LoginTask(String name,String password2){
			this.xmppManager = XmppManager.this;
		...
		public void run() {
			...
			if (!xmppManager.isAuthenticated()) {
				...
				try {
					...
					UISlashActivity.instance.getHandler().obtainMessage(BaseTask.LOGIN_SUCCESS).sendToTarget();
					}else{
						UILoginActivity.instance.getHandler().obtainMessage(BaseTask.LOGIN_SUCCESS).sendToTarget();
