...
public class BaseConfig {
	...
	public static final class api {
		public static final String base				= "http://"+IOUtil.loadProperties(BaseApp.getInstance().getBaseContext()).getProperty("xmppHost", "127.0.0.1")+":8080";
		...
		public static final String test			= "/manager/UserServlet";
		public static final String checkuser			= "/manager/UserServlet";
		public static final String register			= "/manager/UserServlet";
		public static final String login			= "/manager/UserServlet";
		public static final String getfriend			= "/manager/UserServlet";
		public static final String sendmes			= "/manager/UserServlet";
	}
	...
	public static final class task {
		...
		public static final int test				= 1016;
		public static final int checkuser				= 1017;
		public static final int register				= 1018;
		public static final int login				= 1019;
		public static final int getfriend				= 1020;
		public static final int sendmes				= 1021;
