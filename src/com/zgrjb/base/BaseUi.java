...
import com.zgrjb.utils.AppCache;
...
public class BaseUi extends BaseActivity {
	...
	public void doEditText() {
		Intent intent = new Intent();
		intent.setAction(BaseConfig.intent.action.EDITTEXT);
		this.startActivity(intent);
	}
	...
	public void doEditBlog() {
		Intent intent = new Intent();
		intent.setAction(BaseConfig.intent.action.EDITBLOG);
		this.startActivity(intent);
	}
